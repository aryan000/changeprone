...
public class Metric1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(jpb, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//               System.out.println("running");
               ...
               if (myfolder != null) {
                  try {
                     ...
                     if(pb_value==1) addCho(myfolder);
                     else if(pb_value==25) addFchAndLch(myfolder);
                     else if(pb_value==50) addWchAndWCD(myfolder);
                     else if(pb_value==75) addAcdfAndATAF(myfolder);
...
// Adding  CSD and CSBC 
 ...
 // adding lca and lcd
                   try{
                        ...
                        {
                            HashMap<String,TachAndChd> lca = lcaandlcd.get(lch_val);
...
//                System.out.println(filename + boc_value+1 + curr_version );
            ...
            {
                HashMap<String,TachAndChd> lca =  lcaandlcd.get(r);
...
public void create()
    {
        ...
        {  
            ...
            {   
                ...
                jpb.setValue(1100/14);
                addAcdfAndATAF(myfolder);
                jpb.setValue(1400/14);
            ...
            System.out.println("Selected folder is : " + myfolder);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Metric1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
